...
<head>
	<title>Data download Portal</title>
	<meta charset="utf-8">
...
<body>
  ...
  <div id="wrapper">
    ...
    <div class="main">
      <!-- MAIN CONTENT -->
      {% include 'button.php' %}
      <h1>Download World-wide reference station data</h1>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="panel">
                <div class="panel-heading">
                  <h3 class="panel-title">CORS data download portal</h3>
                </div>
                <div class="panel-body">                       
                   
                                <form id="upload-form" action="{{ url_for('download') }}" method="POST" enctype="multipart/form-data">
                          {{ download.csrf_token }}                 
                                <fieldset>
                                  <p style="color:red;">{{error}}</p>
                                  {{ render_field(download.station) }}                          
                                  <p><b>Start Date</b></p>       
                                  <input type="date" name="startDate" required="required"></br></br>
                                    <p><b>End Date</b></p>       
                                  <input type="date" name="endDate" required="required">
                                </br>
                                </br>
                                  {{ render_radio_fields(download.FileType) }}
                                  {{ render_field(download.email) }}
                                  {{ render_field(download.Name) }}
